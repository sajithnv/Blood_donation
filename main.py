...
b1=Button(t,text='ADMIN',command=admin,width=20,font=('ariel',15,'bold'),fg='white',bg='black')
b1.pack(padx=10,pady=20)
b2=Button(t,text=' Donar Reg.Form ',command=donar,width=20,font=('ariel',15,'bold'),fg='white',bg='black')
b2.pack(padx=10,pady=20)
b3=Button(t,text='Patient Reg.Form',command=patient,width=20,font=('ariel',15,'bold'),fg='white',bg='black')
